...
const { NewExpenseDialog } = require('./dialogs/newExpense');

// Greeting Dialog ID
const GREETING_DIALOG = 'greetingDialog';


// New Expense Dialog ID
const NEW_EXPENSE_DIALOG = 'newExpenseDialog';
...
const NEW_EXPENSE_INTENT = 'NewExpense';
...
class BasicBot {
     ...
     */
    constructor(conversationState, userState, botConfig, endpoint, qnaOptions) {
        ...
        this.dialogs.add(new NewExpenseDialog(NEW_EXPENSE_DIALOG))
    ...
    async onTurn(context) {
        ...
        let dialogResult;
            ...
            //await dc.context.sendActivity(`Top_Intent` + topIntent);
                ...
                switch (dialogResult.status) {
                    ...
                    case DialogTurnStatus.empty:
                        ...
                        switch (topIntent) {
                            ...
                            // If you want to include the greeting dialog uncomment the following three lines.
                            // START Include Greeting >>>
                            //case GREETING_INTENT:
                            //    await dc.beginDialog(GREETING_DIALOG);
                            //    break;
                            // <<< END Include Greeting

                            // Handle new expense intent
                            case NEW_EXPENSE_INTENT:
                                await dc.beginDialog(NEW_EXPENSE_DIALOG);
                                break;
